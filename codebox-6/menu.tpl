<span class="header"><img src="images/icons/home.png" alt="" width="16" height="16" class="absmiddle" /> Full Menu </span>

<div class="navigation">

<ul id="menu">
<li><a id="Menu-Clients" {if in_array("List Clients",$admin_perms)}href="clients.php"{/if} title="Clients"><span class="hidden-xs">{$_ADMINLANG.clients.title}</span><span class="pull-right"><i class="fas fa-user"></i></span></a>
  <ul>
...
<li><a id="Menu-Orders" {if in_array("View Orders",$admin_perms)}href="orders.php"{/if} title="Orders"><span class="hidden-xs">{$_ADMINLANG.orders.title}</span><span class="pull-right"><i class="fas fa-shopping-cart"></i></span></a>
  <ul>
...
<li><a id="Menu-Billing" {if in_array("List Transactions",$admin_perms)}href="transactions.php"{/if} title="Billing"><span class="hidden-xs">{$_ADMINLANG.billing.title}</span><span class="pull-right"><i class="fas fa-calculator"></i></span></a>
  <ul>
...
<li><a id="Menu-Support" {if in_array("Support Center Overview",$admin_perms)}href="supportcenter.php"{/if} title="Support"><span class="hidden-xs">{$_ADMINLANG.support.title}</span><span class="pull-right"><i class="fas fa-comments"></i></span></a>
  <ul>
...
{if in_array("View Reports",$admin_perms)}<li><a id="Menu-Reports" title="Reports" href="reports.php"><span class="hidden-xs">{$_ADMINLANG.reports.title}</span><span class="pull-right"><i class="far fa-chart-bar"></i></span></a>
  <ul>
...
<li><a id="Menu-Utilities" title="Utilities" href=""><span class="hidden-xs">{$_ADMINLANG.utilities.title}</span><span class="pull-right"><i class="far fa-file-alt"></i></span></a>
  <ul>
...
<li><a id="Menu-Addons" title="Addons" href="addonmodules.php"><span class="hidden-xs">{$_ADMINLANG.utilities.addonmodules}</span><span class="pull-right"><i class="fas fa-cube"></i></span></a>
    <ul>
...
<li><a id="Menu-Setup" title="Setup" href="{routePath('admin-setup-index')}"><span class="hidden-xs">{$_ADMINLANG.setup.title}</span><span class="pull-right"><i class="fas fa-cog"></i></span></a>
  <ul>
...
<li><a id="Menu-Help" title="Help" href=""><span class="hidden-xs">{$_ADMINLANG.help.title}</span><span class="pull-right"><i class="far fa-life-ring"></i></span></a>
  <ul>
